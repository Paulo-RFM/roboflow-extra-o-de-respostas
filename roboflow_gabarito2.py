...
project = rf.workspace("srinakharinwirot-university-ayja3").project("omr-detect2")

#verificação do download do dataset
if not os.path.exists("OMR-Detect2-2"):
...
image_dir1 = "OMR-Detect2-2/Test/images"
image_dir2 = "OMR-Detect2-2/Train/images"
image_dir3 = "OMR-Detect2-2/valid/images"
...
for filename in os.listdir(image_dir1):
    ...
    #print(img)
    filenamefinal = "dataset_result/OMR2/predictTest/"+filename
    modelo.predict(image_path=image_path, confidence=40, overlap=30,labels=false).save(filenamefinal)

    pathFinal = 'respostasFinais/OMR2/Test/'+filename
...
for filename in os.listdir(image_dir2):
    ...
    #img = modelo.predict(image_path, confidence=40, overlap=30)
    #print(img)
    filenamefinal = "dataset_result/OMR2/predictTrain/"+filename
    modelo.predict(image_path=image_path, confidence=40, overlap=30,labels=false).save(filenamefinal)
